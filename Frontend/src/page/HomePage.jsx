      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-md-8">
            <h1 className="text-color">Welcome to RailConnect</h1>
            <p>
            ...
            <p>
              The user-friendly interface allows travelers to quickly search for available 
              train options, view schedules, and compare fares. Our system provides
              clear and detailed information about each train, including
              departure and arrival times, stops along the route, and available
              amenities, enabling customers to make informed decisions based on
              their preferences and needs.
